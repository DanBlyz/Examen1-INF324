  ...
  <section class="home d-flex align-items-center" id="home" data-scroll-index="0">
    ...
    <div class="container">
       <div class="row align-items-center">
          <div class="col-md-7">
             <div class="home-text">
                <h3 style="color:white">La carrera de Estadística de la Facultad de Ciencias Puras y Naturales de la UMSA, es una unidad académica e investigativa autónoma creada el 15 de octubre de 1984. Es una de las dos únicas unidades de formación de estudiantes en estadística del país, existentes en las ciudades de La Paz y Potosí. Además, tiene la responsabilidad de desarrollar y consolidar el conocimiento científico de la ciencia en estadística al servicio del país.</h3>
             </div>
          </div>
          <div class="col-md-5 text-center">
             <div class="home-img">
                <img src="{{ asset('assets/estadistica.png') }}" alt="shala app">
             </div>
          </div>
       </div>
    </div>
